...
salDir = '../raw/MoCA_Video/'; %MoCA
Models = {'Final_model'}; % Enter the model name
gtDir = '../raw/MoCA_Video/'; 
Datasets = {'TestDataset_per_sq'}; %ValDataset_per_sq TestDataset_per_sq
Results_Save_Path = './Result/MoCA/';
...
for  m = 1:length(Models)
    ...
    for videonum = 1:length(Datasets)
        ...
        for seqnum = 1: seqNUM
            ...
            resPath = ['../results/best_MoCA/' seqfolder '/'] % Enter the path of the results
            disp(resPath)
            ...
            tic;
            for i = 2:fileNUM %skip the first and last gt file for some of the light-flow based method
